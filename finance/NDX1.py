...
mpf.plot(df,title='NDX', type='candle',mav=(25,75),volume=True,\
        addplot=add_plot, volume_panel=3 ,savefig='./data/NDX.png')

df.to_csv('data/NDX.csv', index=True)