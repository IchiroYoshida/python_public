...
df = data.DataReader("7203.T","yahoo",start="2021-01-01",end="2022-05-01")
...
mpf.plot(df2,title='TOYOTA(7203.T)', type='candle',mav=(25,75),volume=True,\
        addplot=add_plot, volume_panel=3 )
