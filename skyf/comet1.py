'''
Skyfield documentation "Drawing a finder chart for coment NEOWISE"
'''
import numpy as np
...
#url=('https://github.com/Stellarium/stellarium/blob/master/skycultures/modern/constellationship.fab')

#
# url=('https://github.com/skyfielders/python-skyfield/blob/master/ci/constellationship.fab')
