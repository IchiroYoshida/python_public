...
data_file_path = '/Users/ichiro3/nasa/Aura/'
...
for i in range(5):
    ...
    EDD = f['HDFEOS/SWATHS/UVB/Data Fields/Irradiance380'][:]
    EDD = np.ravel(EDD)
...
fig.savefig('OMUVBI380ALL.png', bbox_inches='tight', pad_inches = 0.1)
