...
for file in files:
    ...
    if (country == 'Hyogo'):
        ax.plot(dates,D7,color='steelblue', linewidth ='2',zorder=0)
    if (country == 'Okinawa'):
        ax.plot(dates,D7,color='darkred', linewidth ='2',zorder=0)
    if (country == 'Okayama'):
        ax.plot(dates,D7,color='gold', linewidth ='2',zorder=0)
    if (country == 'Hiroshima'):
        ax.plot(dates,D7,color='y', linewidth ='2',zorder=0)
    if (country == 'Aichi'):
        ax.plot(dates,D7,color='m', linewidth ='2',zorder=0)
    if (country == 'Fukuoka'):
        ax.plot(dates,D7,color='green', linewidth ='2',zorder=0)
    if (country == 'Hokkaido'):
        ax.plot(dates,D7,color='cyan',linewidth ='2',zorder=0)
    if (country == 'Kyoto'):
        ax.plot(dates,D7,color='navy',linewidth ='2',zorder=0) 
    if (country == 'Zenkoku'):
...
plt.title('緊急事態宣言区域の倍加時間(Td7)の推移',fontsize=30)
