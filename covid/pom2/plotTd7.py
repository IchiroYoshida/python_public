...
for country0 in countries:
    ...
    if (country == 'Japan'):
        ax.plot(dates,Td7,color='red',linewidth='3',zorder=1)
    else:
        ax.plot(dates,Td7,color=co_col,zorder=0)
...
plt.title('2020 COVID-19 Pandemic Td7',fontsize=30)
plt.ylabel('Td7')
