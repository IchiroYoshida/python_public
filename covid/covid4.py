...
covid4.py
    ...
    death/Mil.population and positions of countries..
        ...
        if(case_Mil):
            if(tot_Cases1 > tot_Cases0):
                if(tot_Death > 1.):
                    ...
                    try:
                        pos1 = pos.countries[country]
                        Lat =pos1[0]
                    except KeyError:
                        Lat = '-'

                    csvRow.append([country,'{:d}'.format(int(tot_Death)), '{:5.3f}'.format(Td),'{:5.3f}'.format(death_Mil),Lat])
...
with open(filename,'w',encoding='utf-8') as file:
    ...
    writer.writerow(['Country','Total deaths','Td','Deaths/Mil.','Latitude'])
