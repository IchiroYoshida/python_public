...
class TideTable(object):
    ...
    def show(year,month, observer):
        ...
        print('\n{:04d} 年'.format(year),'{:>2d} 月'.format(month), observer.name)
        print("日 (曜）潮  月齢 |   満潮 （時刻、潮位cm）       干潮 （時刻、潮位cm） 　")
...
class TideEphemTable(object):
    ...
    def show(year, month, observer):
        ...
        print('\n{:04d} 年'.format(year),'{:>2d} 月'.format(month), observer.name)
        print("日（曜）潮  月齢 |    満潮 （時刻、潮位cm）     　干潮 （時刻、潮位cm） 　|   日の出、入   |   月の出、入")
...
TideEphemTable.show(2019, 7, td)
TideEphemTable.show(2019, 8, td)
