...
days = tide60.month_days(year,month)
...
#    print(date_prn,weekday,moon_prn,hitide_prn,lowtide_prn)
...
#    print('Hitide %-10s %-10s' % (hitide_prn[0],hitide_prn[1]))
