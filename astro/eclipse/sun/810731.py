...
# Date
timetuple = (1981, 7, 31, 2, 50, 00)

# Location
gatech = ephem.Observer()
gatech.lon, gatech.lat = '141.682', '45.419' #Wakkanai, Japan
...
for x in range(0,11000):
    ...
    print("Time = %s r_sun2 = %d r_moon2 = %d az = %d alt = %d" % (gatech.date.datetime(),r_sun2,r_moon2, az, alt))
