...
class Tide(object):
    ...
    def at(self, t):
        ...
        """
        p0 = self.model['phase'][:, np.newaxis]

        print('H  =',H)
        print('p0 = ',p0)
        print('speed = ', speed)

        amp_M2, amp_S2, amp_N2, amp_K1 = (
            np.extract(self.model['constituent'] == c, self.model['amplitude'])
            for c in [constituent._M2, constituent._S2, constituent._N2, constituent._K1]
        )
        print('Amp M2 = %f S2 = %f N2 = %f K1 = %f' % (amp_M2, amp_S2, amp_N2, amp_K1))
    ...
    def form_number(self):
        ...
        #print('k1 = %f o1 = %f m2 = %f s2 = %f' % (k1, o1, m2, s2))
