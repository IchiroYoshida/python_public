...
if __name__ == '__main__':
    #test()
    #solve_all(from_file("easy50.txt", '========')[0:2], "easy", None)
    #solve_all(from_file("top95.txt"), "hard", None)
    #solve_all(from_file("hardest.txt")[0:2], "hardest", None)
    solve_all(from_file("Arto Inkala.txt", '========'), "Arto Inkala", None)
    solve_all([random_puzzle() for _ in range(3)], "random", None)
